...
Model.prototype.findAll = function(options) {
  ...
  // Never use the global option rejectOnEmpty when set locally
...
Model.prototype.findAndCount = function(options) {
  ...
  // SequelizeEmptyResultError should not be thrown in a findAndCount scenario, you will get the count even if empty
  options.rejectOnEmpty = false;
...
Model.prototype.findOrInitialize = Model.prototype.findOrBuild = function(options) {
  ...
  // SequelizeEmptyResultError should not be thrown in a findOrInitialize scenario
  options.rejectOnEmpty = false;
...
Model.prototype.findOrCreate = function(options) {
  ...
  // SequelizeEmptyResultError should not be thrown in a findOrCreate scenario
  options.rejectOnEmpty = false;
...
Model.prototype.findCreateFind = function(options) {
  ...
  // SequelizeEmptyResultError should not be thrown in a findCreateFind scenario
  options.rejectOnEmpty = false;
